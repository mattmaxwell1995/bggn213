...
Calculate mean of every column. apply(x, margin, function). round(x, significant figures)
...
prcomp() is our function for principal component analysis. prcomp(wisc.data, scale = TRUE)
